...
const s = StyleSheet.create({
  screen:{flex:1,backgroundColor:'#F8F3EE'},header:{minHeight:64,paddingVertical:6,backgroundColor:'white',flexDirection:'row',alignItems:'center',paddingHorizontal:12,borderBottomWidth:1,borderBottomColor:'#E9DED7',gap:6},iconButton:{width:44,height:44,borderRadius:15,backgroundColor:'#F6F0EC',alignItems:'center',justifyContent:'center'},headerKicker:{fontSize:8,fontWeight:'900',letterSpacing:1.2,color:colors.orange},headerTitle:{fontSize:16,fontWeight:'900',color:colors.text,marginTop:1},headerCount:{minWidth:42,height:30,paddingHorizontal:8,borderRadius:10,backgroundColor:colors.yellowSoft,alignItems:'center',justifyContent:'center'},headerCountText:{fontSize:11,fontWeight:'900',color:colors.brown},
  content:{paddingBottom:150},hero:{height:255,backgroundColor:'#E8DDD6',overflow:'hidden'},heroImage:{width:'100%',height:'100%',resizeMode:'cover'},heroPlaceholder:{flex:1,alignItems:'center',justifyContent:'center',backgroundColor:colors.yellowSoft},heroShade:{position:'absolute',left:0,right:0,top:0,bottom:0,backgroundColor:'rgba(35,10,6,.08)'},promotion:{position:'absolute',left:16,top:16,borderRadius:11,backgroundColor:colors.red,paddingHorizontal:10,paddingVertical:7,flexDirection:'row',alignItems:'center',gap:5},promotionText:{fontSize:10,fontWeight:'900',color:'white'},heroPrice:{position:'absolute',right:16,bottom:15,alignItems:'flex-end',backgroundColor:'rgba(255,255,255,.94)',paddingHorizontal:13,paddingVertical:9,borderRadius:13},oldPrice:{fontSize:10,color:colors.muted,textDecorationLine:'line-through'},heroPriceText:{fontSize:18,fontWeight:'900',color:colors.brown},
  productIntro:{backgroundColor:'white',paddingHorizontal:18,paddingTop:19,paddingBottom:20,borderBottomLeftRadius:24,borderBottomRightRadius:24},productKicker:{fontSize:9,fontWeight:'900',letterSpacing:1.4,color:colors.orange},title:{fontSize:25,lineHeight:30,fontWeight:'900',color:colors.text,marginTop:4},description:{fontSize:12,lineHeight:18,color:colors.muted,marginTop:6},
  progressCard:{marginHorizontal:16,marginTop:15,backgroundColor:colors.brown,borderRadius:18,padding:15},progressTop:{flexDirection:'row',alignItems:'center',justifyContent:'space-between'},progressTitle:{fontSize:13,fontWeight:'900',color:'white'},progressValue:{fontSize:11,fontWeight:'900',color:colors.yellow},progressTrack:{height:7,borderRadius:4,backgroundColor:'rgba(255,255,255,.15)',overflow:'hidden',marginTop:11},progressFill:{height:'100%',borderRadius:4,backgroundColor:colors.yellow},progressHint:{fontSize:9,color:'#DEC6BF',marginTop:7},
  group:{backgroundColor:'white',borderRadius:20,padding:14,marginHorizontal:16,marginTop:13,borderWidth:1,borderColor:'#E9DED7'},groupInvalid:{borderColor:colors.red,borderWidth:1.5},groupHeader:{flexDirection:'row',alignItems:'center',gap:10,marginBottom:8},stepNumber:{width:34,height:34,borderRadius:12,backgroundColor:colors.yellowSoft,alignItems:'center',justifyContent:'center'},stepNumberDone:{backgroundColor:colors.green},stepNumberText:{fontSize:12,fontWeight:'900',color:colors.brown},groupTitle:{fontSize:16,fontWeight:'900',color:colors.text},rule:{fontSize:10,color:colors.muted,marginTop:2},ruleBadge:{borderRadius:8,paddingHorizontal:7,paddingVertical:5},ruleBadgeRequired:{backgroundColor:'#FBE9E7'},ruleBadgeOptional:{backgroundColor:'#F2EEEB'},ruleBadgeText:{fontSize:6,fontWeight:'900',letterSpacing:.6,color:colors.brown},
  side:{minHeight:62,borderRadius:15,flexDirection:'row',alignItems:'center',gap:11,padding:10,marginTop:7,backgroundColor:'#F8F3EE',borderWidth:1.5,borderColor:'transparent'},sideSelected:{backgroundColor:colors.yellowSoft,borderColor:colors.yellow},sideImage:{width:45,height:45,borderRadius:13,backgroundColor:colors.yellowSoft},check:{width:23,height:23,borderRadius:12,borderWidth:2,borderColor:'#B8AAA6',alignItems:'center',justifyContent:'center'},checkSelected:{backgroundColor:colors.brown,borderColor:colors.brown},sideName:{fontSize:13,fontWeight:'900',color:colors.text},sidePrice:{fontSize:10,color:colors.muted,marginTop:3},sideQty:{height:36,borderRadius:12,backgroundColor:'white',flexDirection:'row',alignItems:'center',gap:10,paddingHorizontal:8},sideQtyText:{fontWeight:'900',color:colors.brown},
  noteHead:{flexDirection:'row',alignItems:'center',gap:10,marginHorizontal:18,marginTop:20,marginBottom:9},noteIcon:{width:38,height:38,borderRadius:13,backgroundColor:colors.yellowSoft,alignItems:'center',justifyContent:'center'},noteLabel:{fontSize:14,fontWeight:'900',color:colors.text},noteHelp:{fontSize:9,color:colors.muted,marginTop:2},note:{minHeight:92,borderRadius:16,backgroundColor:'white',borderWidth:1,borderColor:'#E9DED7',padding:13,textAlignVertical:'top',color:colors.text,marginHorizontal:16},error:{color:colors.red,fontSize:12,fontWeight:'800',marginHorizontal:18,marginTop:12},
  quantity:{height:54,borderRadius:17,backgroundColor:'#F6F0EC',flexDirection:'row',alignItems:'center',gap:7,paddingHorizontal:6},qtyButton:{width:40,height:40,borderRadius:13,backgroundColor:'white',alignItems:'center',justifyContent:'center'},qtyText:{fontSize:18,fontWeight:'900',color:colors.text,minWidth:24,textAlign:'center'},footer:{position:'absolute',left:0,right:0,bottom:0,paddingHorizontal:14,paddingTop:12,paddingBottom:14,backgroundColor:'white',borderTopWidth:1,borderTopColor:'#E9DED7',flexDirection:'row',gap:10},confirm:{height:54,borderRadius:17,backgroundColor:colors.yellow,flex:1,paddingHorizontal:17,flexDirection:'row',alignItems:'center',justifyContent:'space-between'},confirmKicker:{fontSize:7,fontWeight:'900',letterSpacing:.8,color:colors.brown},confirmText:{fontSize:16,fontWeight:'900',color:colors.brown,marginTop:2},
});
