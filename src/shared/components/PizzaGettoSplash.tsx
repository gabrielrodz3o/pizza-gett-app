...
const s = StyleSheet.create({
  ...
  kicker: { fontFamily: 'Montserrat_900Black', fontSize: 10, letterSpacing: 1.4, color: '#FFC100' },
  ...
  pizzaName: { fontFamily: 'Montserrat_900Black', fontSize: 10, letterSpacing: 1.4, color: '#FFC100' },
  ...
  lid: { position: 'absolute', top: 0, left: 0, backgroundColor: '#FFC100', alignItems: 'center', justifyContent: 'center', transformOrigin: 'top', shadowColor: '#000', shadowOpacity: 0.22, shadowRadius: 18, shadowOffset: { width: 0, height: 12 }, elevation: 14 },
  ...
  aromaBadge: { position: 'absolute', right: 20, bottom: 108, flexDirection: 'row', alignItems: 'center', gap: 5, backgroundColor: '#FFC100', paddingHorizontal: 11, paddingVertical: 8 },
  ...
  progressFill: { width: '100%', height: '100%', borderRadius: 2, backgroundColor: '#FFC100', transformOrigin: 'left' },
});
