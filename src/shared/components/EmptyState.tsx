...
const s=StyleSheet.create({empty:{alignItems:'center',paddingVertical:65,paddingHorizontal:25},icon:{width:72,height:72,borderRadius:24,backgroundColor:colors.yellowSoft,alignItems:'center',justifyContent:'center'},title:{fontSize:18,fontFamily: font.black,color:colors.text,marginTop:15,textAlign:'center'},body:{fontSize:13,lineHeight:19,color:colors.muted,textAlign:'center',marginTop:7}})
