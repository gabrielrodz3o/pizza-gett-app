...
const s=StyleSheet.create({banner:{position:'absolute',left:12,right:12,top:54,zIndex:9999,minHeight:38,borderRadius:12,backgroundColor:'#8F2D25',flexDirection:'row',alignItems:'center',justifyContent:'center',gap:7,paddingHorizontal:12},text:{fontSize:11,fontFamily: font.black,color:'white'}});
